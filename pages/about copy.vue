<template>
  ...
  <div v-else class="leading-tight mb-24">
    ...
    <div class="px-7 md:flex space-y-3 md:space-x-6 md:space-y-0">
      <div
        class="p-8 border border-zinc-200 dark:border-zinc-600 md:w-56 min-h-full rounded-xl pb-32"
      >
        <h2 class="font-semibold text-xl mb-2">Безпека</h2>
        <p class="text-sm leading-tight">
          Ми створили цифровий простір, де можна відверто ділитися думками й
          спогадами про місця, яких уникаєте. Це допоможе привернути увагу
          спільноти й запустити процес змін.
        </p>
      </div>
      <div
        class="p-8 border border-zinc-200 dark:border-zinc-600 md:w-56 min-h-full rounded-xl"
      >
        <h2 class="font-semibold text-xl mb-2">Приналежність</h2>
        <p class="text-sm leading-tight">
          Стежка до річки, квітучий сквер, культурний центр — позначайте
          улюблені місця та дізнавайтеся, які локації обирають інші містяни.
        </p>
      </div>
      <div
        class="p-8 border border-zinc-200 dark:border-zinc-600 md:w-56 min-h-full rounded-xl"
      >
        ...
        <p class="text-sm leading-tight">
          Завдяки згуртованості містян, онлайн мапа наочно відображає популярні
          локації та ділянки, які потребують відновлення для процвітання міста.
        </p>
      </div>
      <div
        class="p-8 border border-zinc-200 dark:border-zinc-600 md:w-56 min-h-full rounded-xl"
      >
        ...
        <p class="text-sm leading-tight">
          Платформа збирає й систе-матизує дані про рослини та тварин,
          характерних для місцевості. А також фіксує засмічені зони, які
          гальмують розвиток міста. Поділитися своїми враженнями — перший крок
          до покращень.
        </p>
      </div>
    </div>
    ...
    <div class="px-7 md:w-9/12 md:max-w-[1100px]">
      ...
      <div class="md:w-9/12 space-y-2 mb-8">
        ...
        <p>
          ...
          Restart стала цифровим партнером, спрямований на відновлення зв'язку
          між річкою та міським простором. Ініціатива є частиною більшої
          стратегії Зеленого курсу Вінниці, яку міська рада оголосила в січні
          2022 року. Мета — забезпечити сталий розвиток міста через екологічно
          орієнтовані проєкти та активне залучення інвестицій для покращення
          інфраструктури.
        </p>
        <p>
          Ще одним партнером виступає «Інститут розвитку міст», який вже
          реалізував кілька важливих проєктів для сталого розвитку Вінниці (один
          з яких — «Вінницький луг»).
        </p>
        <p>
          ...
          зону для відпочинку або розчистити територію від зайвого сміття.
          Зокрема це актуально для жителів віддалених мікрорайонів, які можуть
          впливати на зміни в один клік.
        </p>
      </div>
    ...
    <div class="px-7">
      <div class="md:flex place-items-center justify-between">
        <h1 class="text-2xl leading-tight text-zinc-900 dark:text-white">
          Drawing Participation<br />Гуртомá
        </h1>
        <div class="flex space-x-6 md:pr-2 !place-items-center">
          <a href="https://www.northeastern.edu" target="_blank"
            ><img
              ...
              class="hover:scale-105 dark:invert"
          /></a>
          <a href="https://www.restartfuture.org" target="_blank"
            ><img
          ...
          /></a>
          <a
            href="https://www.facebook.com/SmallRiversVinnytsia"
            target="_blank"
            ><img
